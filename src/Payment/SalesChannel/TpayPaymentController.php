...
{
    protected EntityRepositoryInterface $tpayPaymentTokenRepository;
    ...
    /**
     * @Route("/tpay/payment/return-url/{tokenId}", name="tpay.payment.return-url", methods={"GET"})
     */
    ...
    /**
     * @Route("/tpay/payment/result-url/{tokenId}", name="tpay.payment.result-url", methods={"GET"})
     */
    ...
    /**
     * @Route("/tpay/payment/check-payment", name="tpay.payment.check-payment", methods={"GET"})
     */
